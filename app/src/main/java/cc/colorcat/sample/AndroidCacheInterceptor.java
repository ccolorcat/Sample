...
import cc.colorcat.netbird.cache.CacheInterceptor;
import cc.colorcat.netbird.cache.DiskCache;
...
public final class AndroidCacheInterceptor extends CacheInterceptor {
    ...
    protected AndroidCacheInterceptor(Context context, DiskCache diskCache, List<String> ignoredQueryNames) {
